...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.f_new_user = "ghilardi.miriam@hotmail.com"
        self.f_new_pass = 25
        
        #add_employee
        self.new_mail_employee = "marco.visentin@gold1.com"
        self.new_pass_employee = "Marco2000"
        self.f_mail_employee = "rita"
        self.f_pass_employee = []
    ...
    #def test_log_in(self):
        ...
        #self.assertFalse(log_in(self.t_email_user, self.f_password_user))
        #self.assertFalse(log_in(self.f_email_user, self.t_password_user))
        #self.assertTrue(log_in(self.t_email_employee, self.t_password_employee))
        #self.assertFalse(log_in(self.t_email_employee, self.f_password_employee))
        #self.assertFalse(log_in(self.f_log_employee, self.t_password_employee))
        
        
    #def test_add_user(self):
        #self.assertTrue(add_user(self.new_mail_user, self.new_pass_user))
        #self.assertFalse(add_user(self.new_mail_user, self.f_new_pass))
        #self.assertFalse(add_user(self.f_mail_employee, self.new_pass_user))
        
        
    def test_add_employee(self):  
        #self.assertTrue(add_employee(self.new_mail_employee, self.new_pass_employee))
        self.assertFalse(add_employee(self.new_mail_employee, self.f_pass_employee))
        #self.assertFalse(add_employee(self.f_mail_employee, self.new_pass_employee))
        
        
    #def test_buy_metals(self):
        #self.assertTrue(buy_metal(self.mail_client, self.metal, self.quantity))
        #self.assertFalse(buy_metal(self.mail_client, self.f_metal, self.quantity ))
        #self.assertFalse(buy_metal(self.mail_client, self.metal, self.f_quantity))
